...
class PantallaFormularioClientes extends StatefulWidget {
  final Cliente? cliente;

  PantallaFormularioClientes({this.cliente});

  @override
  _PantallaFormularioClientesState createState() => _PantallaFormularioClientesState();
}

class _PantallaFormularioClientesState extends State<PantallaFormularioClientes> {
  ...
  void initState() {
    ...
    if (widget.cliente != null) {
      ...
      _identificadorController.text = widget.cliente!.direccion;
    }
  }
  ...
  void _confirmar() {
    final clienteModificado = Empleado(
